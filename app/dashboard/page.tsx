...
export default function DashboardIndexPage() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center justify-center p-6 relative overflow-hidden">
      {/* Background aesthetics */}
      <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_center,rgba(124,92,255,0.05),transparent_50%)]" />
      <div className="absolute top-0 w-full h-px bg-gradient-to-r from-transparent via-primary-accent/30 to-transparent" />
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-muted-text">Select your authorized clearance level to access the intelligence platform.</p>
        </div>
