    ...
    <div className="flex h-full w-full flex-col items-center justify-center p-8 text-center">
      ...
      >
        <div className="rounded-full bg-primary-accent/20 p-4">
          <LifeBuoy className="h-12 w-12 text-primary-accent" />
        </div>
        <div className="space-y-2">
          <h2 className="font-display text-2xl font-bold text-white tracking-tight">Support & Help Desk</h2>
          <p className="text-muted-text">
            Our priority support channels and knowledge base are currently being integrated. Check back soon for 24/7 AI-assisted support.
          </p>
        </div>
